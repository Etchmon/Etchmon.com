    ...
    <div className="projects">
        ...
        <div>
          ...
          <div className="svgs">
            ...
            >
              ...
              ></path>
              <path d="M3 3v26h26V3H3zm2 2h22v18H5V5z"></path>
            </svg>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 128 128"
          ...
          <p>
            A full-stack application that provides a friendly user interface for
            creating and editing recipes, cookbooks, and explore recipes from
            other users. Built using React, Next.js, Tailwind CSS, Node.js,
            MongoDB and deployed with Vercel.{' '}
          </p>
          <div>
            <a
              href="https://github.com/Etchmon/nextjs-cookbook"
              target="_blank"
            >
              Code
            </a>
            <a
              href="https://nextjs-cookbook-5eel0530o-etchmon.vercel.app/"
              target="_blank"
            >
              Link
            </a>
      ...
      <div className="two">
        <div>
          ...
          <p>
            E-commerce website prototype encompassing a visually appealing
            landing page, comprehensive product lists, and an efficient shopping
            cart system. Built using React and Node.js, deployed on github
            pages.
          </p>
          <div>
            ...
            >
              ...
              >
                <path
                  ...
                  data-name="<Path>"
                ></path>
                <circle cx="12" cy="7" r="1.5" data-name="<Path>"></circle>
                <circle cx="17" cy="12" r="1.5" data-name="<Path>"></circle>
                <circle cx="12" cy="17" r="1.5" data-name="<Path>"></circle>
                <path d="m13.05 8.07 2.88 2.88" data-name="<Path>"></path>
              </g>
            </svg>
          </div>
          <p>
            A web application that provides real-time weather information for
            various locations using the OpenWeatherAPI. It allows users to
            search for a specific location and view the current weather
            conditions as well as the forecast for the upcoming days.
          </p>
          <div>
      ...
      <div className="four">
        <div>
          ...
          <p>
            A CV application that lets a user input their personal information,
            education, and work experience then builds a form to display all
            their information for hiring managers to view.
          </p>
          <div>
