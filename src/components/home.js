...
const Home = () => {
    ...
    return (
        <header>
            ...
            <ul>
                <li>
                    <a href='https://github.com/Etchmon' target='_blank'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="60px" height="60px" viewBox="0 0 20 20" version="1.1">
                ...
                <li>
                    <a href='https://www.linkedin.com/in/james-etchells-240816164/' target='_blank'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" height="60px" width="60px" version="1.1" id="Layer_1" viewBox="-143 145 512 512">
                ...
                <li>
                    <a href='mailto:jaw.etch@gmail.com' target='_blank'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="60px" height="60px" viewBox="0 -2.5 20 20" version="1.1">
                            <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li>
                    <a href='/images/resume.pdf' download>
                        <svg xmlns="http://www.w3.org/2000/svg" height="60px" width="60px" version="1.1" id="_x32_" fill="#ffffff" viewBox="0 0 512 512">
                            <g>
